...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.SWGSOpx' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_SWGSOpxService()
    {
        return $this->privates['.service_locator.SWGSOpx'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder06da3 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer7e6ce = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties061ce = [
        
    ];

    public function getConnection()
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'getConnection', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'getMetadataFactory', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'getExpressionBuilder', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'beginTransaction', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'getCache', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->getCache();
    }

    public function transactional($func)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'transactional', array('func' => $func), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'wrapInTransaction', array('func' => $func), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'commit', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->commit();
    }

    public function rollback()
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'rollback', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'getClassMetadata', array('className' => $className), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'createQuery', array('dql' => $dql), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'createNamedQuery', array('name' => $name), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'createQueryBuilder', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'flush', array('entity' => $entity), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'clear', array('entityName' => $entityName), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->clear($entityName);
    }

    public function close()
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'close', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->close();
    }

    public function persist($entity)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'persist', array('entity' => $entity), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'remove', array('entity' => $entity), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'refresh', array('entity' => $entity), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'detach', array('entity' => $entity), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'merge', array('entity' => $entity), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'getRepository', array('entityName' => $entityName), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'contains', array('entity' => $entity), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'getEventManager', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'getConfiguration', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'isOpen', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'getUnitOfWork', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'getProxyFactory', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'initializeObject', array('obj' => $obj), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'getFilters', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'isFiltersStateClean', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'hasFilters', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return $this->valueHolder06da3->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer7e6ce = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder06da3) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder06da3 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder06da3->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, '__get', ['name' => $name], $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        if (isset(self::$publicProperties061ce[$name])) {
            return $this->valueHolder06da3->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder06da3;
    ...
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;
    ...
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, '__isset', array('name' => $name), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;
    ...
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, '__unset', array('name' => $name), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;
    ...
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, '__clone', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        $this->valueHolder06da3 = clone $this->valueHolder06da3;
    }

    public function __sleep()
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, '__sleep', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        return array('valueHolder06da3');
    }
    ...
    {
        $this->initializer7e6ce = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer7e6ce;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'initializeProxy', array(), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder06da3;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder06da3;
    }
}
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer7e6ce && ($this->initializer7e6ce->__invoke($valueHolder06da3, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer7e6ce) || 1) && $this->valueHolder06da3 = $valueHolder06da3;

        if ($this->valueHolder06da3 === $returnValue = $this->valueHolder06da3->paginate($target, $page, $limit, $options)) {
            return $this;
        }
