...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.Yk6ew.B' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Yk6ew_BService()
    {
        return $this->privates['.service_locator.Yk6ew.B'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getConsole_Command_FormDebugService()
    {
        ...
        $this->privates['console.command.form_debug'] = $instance = new \Symfony\Component\Form\Command\DebugCommand(($this->privates['form.registry'] ?? $this->getForm_RegistryService()), [0 => 'Symfony\\Component\\Form\\Extension\\Core\\Type', 1 => 'App\\Form', 2 => 'Symfony\\Bridge\\Doctrine\\Form\\Type'], [0 => 'App\\Form\\CommentaireType', 1 => 'App\\Form\\PostType', 2 => 'App\\Form\\Reclamation1Type', 3 => 'App\\Form\\ReclamationType', 4 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FormType', 5 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType', 6 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FileType', 7 => 'Symfony\\Bridge\\Doctrine\\Form\\Type\\EntityType'], [0 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\TransformationFailureExtension', 1 => 'Symfony\\Component\\Form\\Extension\\HttpFoundation\\Type\\FormTypeHttpFoundationExtension', 2 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\FormTypeValidatorExtension', 3 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\RepeatedTypeValidatorExtension', 4 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\SubmitTypeValidatorExtension', 5 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\UploadValidatorExtension', 6 => 'Symfony\\Component\\Form\\Extension\\Csrf\\Type\\FormTypeCsrfExtension', 7 => 'Symfony\\Component\\Form\\Extension\\DataCollector\\Type\\DataCollectorTypeExtension'], [0 => 'Symfony\\Component\\Form\\Extension\\Validator\\ValidatorTypeGuesser', 1 => 'Symfony\\Bridge\\Doctrine\\Form\\DoctrineOrmTypeGuesser'], ($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService()));
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.Yk6ew.B'] ?? $this->get_ServiceLocator_Yk6ew_BService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder1bce4 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerd4401 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesa1317 = [
        
    ];

    public function getConnection()
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'getConnection', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'getMetadataFactory', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'getExpressionBuilder', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'beginTransaction', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'getCache', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->getCache();
    }

    public function transactional($func)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'transactional', array('func' => $func), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'wrapInTransaction', array('func' => $func), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'commit', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->commit();
    }

    public function rollback()
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'rollback', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'getClassMetadata', array('className' => $className), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'createQuery', array('dql' => $dql), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'createNamedQuery', array('name' => $name), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'createQueryBuilder', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'flush', array('entity' => $entity), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'clear', array('entityName' => $entityName), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->clear($entityName);
    }

    public function close()
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'close', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->close();
    }

    public function persist($entity)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'persist', array('entity' => $entity), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'remove', array('entity' => $entity), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'refresh', array('entity' => $entity), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'detach', array('entity' => $entity), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'merge', array('entity' => $entity), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'getRepository', array('entityName' => $entityName), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'contains', array('entity' => $entity), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'getEventManager', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'getConfiguration', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'isOpen', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'getUnitOfWork', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'getProxyFactory', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'initializeObject', array('obj' => $obj), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'getFilters', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'isFiltersStateClean', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'hasFilters', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return $this->valueHolder1bce4->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerd4401 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder1bce4) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder1bce4 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder1bce4->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, '__get', ['name' => $name], $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        if (isset(self::$publicPropertiesa1317[$name])) {
            return $this->valueHolder1bce4->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder1bce4;
    ...
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;
    ...
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, '__isset', array('name' => $name), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;
    ...
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, '__unset', array('name' => $name), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;
    ...
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, '__clone', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        $this->valueHolder1bce4 = clone $this->valueHolder1bce4;
    }

    public function __sleep()
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, '__sleep', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        return array('valueHolder1bce4');
    }
    ...
    {
        $this->initializerd4401 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerd4401;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'initializeProxy', array(), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder1bce4;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder1bce4;
    }
}
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializerd4401 && ($this->initializerd4401->__invoke($valueHolder1bce4, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializerd4401) || 1) && $this->valueHolder1bce4 = $valueHolder1bce4;

        if ($this->valueHolder1bce4 === $returnValue = $this->valueHolder1bce4->paginate($target, $page, $limit, $options)) {
            return $this;
        }
