...
class __TwigTemplate_f042e9512e75baca290d3b4a6cfbf01b1c49024bd2deeb5cc374381a7811fafe extends Template
{
    private $source;
    private $macros = [];
    ...
    <button class=\"btn\" style=\"background-color:grey;border-color: black;color: purple\">";
        // line 8
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 8, $this->source); })()), "Save")) : ("Save")), "html", null, true);
        echo "</button>
";
        // line 9
    ...
    {
        return array (  63 => 9,  59 => 8,  51 => 3,  47 => 2,  43 => 1,);
    }
...
{{ form_end(form) }}", "commentaire/_form.html.twig", "C:\\xampp\\htdocs\\PIDEV\\templates\\commentaire\\_form.html.twig");
    }
}
