...
/* user/base.html.twig */
class __TwigTemplate_12b4f6087cf4c16f1cd415474913beefc58d6e8c524951a8a80dc4f6df865aff extends Template
{
    private $source;
    private $macros = [];
...
<html>
    ...
    <body class=\"";
        ...
        ";
        // line 22
        if ((0 !== twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 22, $this->source); })()), "request", [], "any", false, false, false, 22), "attributes", [], "any", false, false, false, 22), "get", [0 => "_route"], "method", false, false, false, 22), "login"))) {
            // line 23
            echo "            ";
...
", "user/base.html.twig", "C:\\xampp\\htdocs\\PIDEV\\templates\\user\\base.html.twig");
    }
}
