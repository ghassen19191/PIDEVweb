...
class __TwigTemplate_c7640cf89e3c67bebef7f33b54bffeceafa4446d5207b3a4b444a3ef458a1e84 extends Template
{
    private $source;
    private $macros = [];
    ...
    <button class=\"btn\" style=\"background-color:#3498DB;border-color: black;color: white\">";
        // line 6
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 6, $this->source); })()), "Send")) : ("Send")), "html", null, true);
        echo "</button>
";
        // line 7
...
";
    ...
    <button class=\"btn\" style=\"background-color:#3498DB;border-color: black;color: white\">{{ button_label|default('Send') }}</button>
{{ form_end(form) }}
", "reclamation/_form.html.twig", "C:\\xampp\\htdocs\\PIDEV\\templates\\reclamation\\_form.html.twig");
    }
}
