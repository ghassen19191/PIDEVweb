...
/* base.html.twig */
class __TwigTemplate_301595f9ba1f7cdf2c0b60d53735afe996d0d7d3848867577f8207fdf12d8f62 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t <li class=\"nav-item dropdown no-arrow\">
        ...
        // line 79
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 79, $this->source); })()), "user", [], "any", false, false, false, 79), "fullName", [], "any", false, false, false, 79), "html", null, true);
        echo "</span>
                ";
        // line 81
        echo "            </a>
...
\t\t<div class=\"container\">
\t\t\t<h1>Visit Us</h1>
\t\t\t<iframe src=\"https://www.google.com/maps/d/u/0/embed?mid=17Ve5ZIqiiFiM8nqgss4Rd1-N9jpSGiIg&ehbc=2E312F\" width=\"640\" height=\"480\"></iframe>
...
\t<script src=\"";
        // line 240
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("js/jquery.magnific-popup.min."), "html", null, true);
        echo "\"></script>
\t<script src=\"";
        // line 241
...
\t<script src=\"{{ asset('js/jquery.magnific-popup.min.')}}\"></script>
