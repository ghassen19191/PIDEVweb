...
class __TwigTemplate_c4cb205b54c5be0615cf27e36694afbb8cd716904431d07e05091d1328119c47 extends Template
{
    private $source;
    private $macros = [];
...
\t<title>Hunters</title>
        ...
        echo " - ";
        echo twig_escape_filter($this->env, (isset($context["const_website_title"]) || array_key_exists("const_website_title", $context) ? $context["const_website_title"] : (function () { throw new RuntimeError('Variable "const_website_title" does not exist.', 12, $this->source); })()), "html", null, true);
        echo "
        </title>
    ...
    <body class=\"";
        // line 23
        ((array_key_exists("body_class", $context)) ? (print (twig_escape_filter($this->env, (isset($context["body_class"]) || array_key_exists("body_class", $context) ? $context["body_class"] : (function () { throw new RuntimeError('Variable "body_class" does not exist.', 23, $this->source); })()), "html", null, true))) : (print ("")));
        echo "\">
        ";
        // line 24
        if ((0 !== twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 24, $this->source); })()), "request", [], "any", false, false, false, 24), "attributes", [], "any", false, false, false, 24), "get", [0 => "_route"], "method", false, false, false, 24), "login"))) {
            // line 25
            echo "            ";
...
";
    ...
    {
        return array (  231 => 38,  213 => 36,  195 => 20,  177 => 12,  163 => 48,  157 => 45,  151 => 42,  147 => 41,  143 => 39,  141 => 38,  138 => 37,  136 => 36,  133 => 35,  130 => 34,  122 => 31,  113 => 29,  109 => 28,  105 => 27,  102 => 26,  97 => 25,  95 => 24,  91 => 23,  87 => 21,  85 => 20,  80 => 18,  76 => 17,  71 => 15,  63 => 12,  57 => 9,  47 => 1,);
    }
...
", "admin/base.html.twig", "C:\\xampp\\htdocs\\PIDEV\\templates\\admin\\base.html.twig");
    }
}
